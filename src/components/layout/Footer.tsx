  ...
  return (
    <footer className="border-t border-gray-200 bg-gray-50 dark:border-slate-700 dark:bg-slate-800">
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mt-6 flex justify-center gap-4">
          {SOCIAL_LINKS.map((link) => (
            <a
              ...
              className="text-gray-500 transition-colors hover:text-gray-900 dark:text-slate-400 dark:hover:text-slate-100"
        ...
        <div className="mt-6 border-t border-gray-200 pt-4 text-center dark:border-slate-700">
